...
if __name__ == "__main__":
    print("use resnet")
    model_path = "/home/tt/Downloads/resnet50_28_133.90598738193512.model"
    ...
    landmark_input_test = "/data/cv_data/ai/testset"
    # model_base_path = "/home/zdeploy/thient/model/landmark/landmark5"
    print("path----------")
    print(landmark_input_test)
    print(model_path)
    print("===============")
    ...
    dataset = ImageFolderWithPaths(landmark_input_test, transform=val_transform)  # our custom dataset
    ...
    resultfile = open("resultlandmark5_v2_28.csv", "w")
    ...
    with torch.no_grad():
        ...
        for datapoint in data_loader:
            ...
            for f, m_pred in zip(path, multi_preds):
                ...
                pending_str = str(id) + ","
                for pred in m_pred:
                    pending_str += str(imagenet_data.classes[pred.item()]) + " "
